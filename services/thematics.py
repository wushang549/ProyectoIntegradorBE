...
_ASPECT_PRIORITY = ("food", "service", "value", "speed", "cleanliness", "atmosphere", "general")
_ASPECT_KEYWORDS = {
    "food": {
        "food",
        "dish",
    ...
    "value": {"price", "prices", "overpriced", "value", "money", "cost", "cheap", "expensive", "portion", "portions"},
    "atmosphere": {"atmosphere", "cozy", "noisy", "vibe", "interior", "ambience", "music", "environment"},
    "cleanliness": {"dirty", "clean", "smelled", "smell", "table", "bathroom", "sticky"},
    "speed": {"slow", "quick", "quickly", "wait", "arrived", "late", "fast"},
}
